		...
		<div class="leftArea">
			<div class="description_imgs">
				...
				<ul class="des_smimg clearfix" id="thumblist">
					...
					<li><a class="<?php echo $key==0?"zoomThumbActive":""; ?> avtive" href="javascript:void(0);" rel="{gallery:'gal1',smallimage:'image_350/<?php echo $proImg['albumPath']; ?>',largeimage:'image_800/<?php echo $proImg['albumPath']; ?>'}"><img src="image_50/<?php echo $proImg['albumPath']; ?>" alt=""></a></li>
					<?php endforeach; ?>
				</ul>
			</div>
		</div>
